...
(function () {
    ...
    function controlcambios($scope, $window,$routeParams, serviceAdmin, $timeout, FileUploader) {
        ...
        function activate() {
            ...
            $scope.AgregarControldeCambios = function () {
                console.log($scope.version.Componentes.length);


                serviceAdmin.addControlCambios($scope.idVersion, $scope.formData.modulo, $scope.formData.release, $scope.formData.tips, $scope.formData.desccc,$scope.formData.impacto).success(function (data) {
                    $scope.controlCambios = data;
                    $scope.formData.modulo = data.Modulo;
                    $scope.formData.release = data.Release;
                    $scope.formData.tips = data.Tips;
