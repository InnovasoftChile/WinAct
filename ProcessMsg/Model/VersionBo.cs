    ...
    public class VersionBo
    {
        ...
        public string IsVersionInicialFmt
        {
            get
            {
                ...
                {
                    return "Version full";
                }else if(!IsVersionInicial && Estado == 'Q')
                {
                    return "Version Parcial (En QA)";
                }
                else if (!IsVersionInicial && Estado == 'R')
                {
                    return "Version Parcial (Lista para ser Publicada)";
                }
                else
                {
                    return "Version Parcial";
                }
            }
        }
        ...
        public string EstadoDisplay
        {
            get
            {
                return Estado == 'P' ? "Publicada" : Estado == 'N' ? "Nueva" : Estado == 'Q' ? "QA" : Estado == 'R' ? "Lista" : "No Vigente";
            }
        }
