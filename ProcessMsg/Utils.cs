...
namespace ProcessMsg
{
    public static class Utils
    {
        ...
        /// <summary>
        /// Cifrar una cadena de string
        /// </summary>
        /// <param name="cadena">cadena a cifrar</param>
        /// <returns>cadena cifrada</returns> portal todo string
        public static string cifrar(string cadena, string seed)
        {
            ...
            llave = md5.ComputeHash(UTF8Encoding.UTF8.GetBytes(seed));
            md5.Clear();
        ...
        public static string descifrar(string cadena, string seed)
        {
