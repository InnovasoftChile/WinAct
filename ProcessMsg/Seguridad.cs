...
namespace ProcessMsg
{
    public class Seguridad
    {
        ...
        public static List<Model.PersonaBo> GetAdmins()
        {
            var lista = new List<Model.PersonaBo>();
            var consulta = new CnaUsuario();
            try
            {
                var dr = consulta.ExecuteAdmCl();
                while (dr.Read())
                {
        ...
        public static int DelUsuario(int idUsuario)
        {
            try
            {
                var query = new CnaUsuario();

                return query.DelUsuario(idUsuario);
            }
            catch (Exception ex)
            {
                var msg = "Excepcion Controlada: " + ex.Message;
        ...
        public static int DelPersona(int idPersona)
        {
            try
            {
                var query = new CnaUsuario();

                return query.DelPersonas(idPersona);
            }
            catch (Exception ex)
            {
                var msg = "Excepcion Controlada: " + ex.Message;
